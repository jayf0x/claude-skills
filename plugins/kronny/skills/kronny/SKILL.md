...
name: kronny
description: >
  Activated via the /kronny and /kronny-ttl slash commands. Use when the user
  says /kronny or /kronny-ttl.
---
...
- `/kronny-ttl` → run `python3 ~/.claude/kronny/kronny.py status` via Bash.
